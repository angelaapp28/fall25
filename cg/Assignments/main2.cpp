...
{
	&InputRayFile , &OutputImageFile , &ImageWidth , &ImageHeight , &RecursionLimit , &CutOffThreshold , &LightSamples , &BinaryShadows , &Progress , &Parallelization ,
	NULL
};
...
int main( int argc , char *argv[] )
{
	...
	try
	{
		...
		Image32 img = scene.rayTrace( ImageWidth.value , ImageHeight.value , RecursionLimit.value , CutOffThreshold.value , LightSamples.value , BinaryShadows.set , Progress.set );
